...
\tiny{{\singlespacing \emph{Notes:} IV-FE estimates from Equation (2). The reported coefficient is the interaction between retirement and the high-unemployment indicator. Depression is a binary indicator equal to one when the respondent reports four or more CES-D symptoms. ``Pre-retirement mean'' is the outcome mean among observations prior to retirement in each sample. ``Effect size (\%)'' scales the coefficient by that mean. ``Kleibergen-Paap rk Wald F'' reports the weak-instrument statistic for the excluded instrument set. All specifications include individual fixed effects, wave indicators, and the full set of controls described in Section 4. Clustered standard errors at the individual level are in parentheses. Significance levels: ***p$\prec$0.01; **p$\prec$0.05; *p$\prec$0.1.}}
\end{table}
...
\tiny{{\singlespacing \emph{Notes:} IV-FE estimates from Equation (2) using the continuous CES-D symptom count instead of the binary depression indicator. ``Pre-retirement mean'' is the outcome mean among observations prior to retirement. ``Effect size (\%)'' scales the coefficient by that mean. Clustered standard errors at the individual level are in parentheses. Significance levels: ***p$\prec$0.01; **p$\prec$0.05; *p$\prec$0.1.}}
\end{table}
